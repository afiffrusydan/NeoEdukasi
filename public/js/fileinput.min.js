...
! function (e) {
    ...
    t = {
                ...
                i = a.resumableManager = {
                    ...
                    sendAjax: function (e, s, l) {
                        ...
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (s > r.maxRetries) return h(m.resumableMaxRetriesReached, {
                                n: r.maxRetries
                            }), void i.setProcessed("error");
                            var v, w, b, _, C, x, y = p.slice ? "slice" : p.mozSlice ? "mozSlice" : p.webkitSlice ? "webkitSlice" : "slice",
                                T = p[y](c * e, c * (e + 1));
                            v = new FormData, d = o.stack[u], a._setUploadData(v, {
                                ...
                                return a._isAborted() ? void h(m.resumableAborting) : (w = a._getOutData(v, t), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, s, o, i, w]), i.pushAjax(e, s + 1), void h(m.resumableRetryError, {
                                    n: s - 1
                                }))
                            }, x = function () {
        ...
        _initTemplateDefaults: function () {
            var i, a, r, n, o, s, l, d, c, u, p, f, m, g, h, v, w, b, _, C, x, y, T, P, k, F, S, E, I, A, D, z, j, $, U, M, R, B, O, L, N, Z, H, W = this,
                q = function (e, i) {
        ...
        _initPreviewCache: function () {
            ...
            i.previewCache = {
                ...
                get: function (e, a) {
                    ...
                    return m && m.length ? (a = void 0 === a ? !0 : a, o = t.ifSet("type", f, i.initialPreviewFileType || "generic"), l = t.ifSet("filename", f, t.ifSet("caption", f)), d = t.ifSet("filetype", f, o), s = i.previewCache.footer(e, a, f && f.size || null), c = t.ifSet("frameClass", f), r = g ? v(o, m, l, d, s, u, c) : v("generic", m, l, d, s, u, c, o).setTokens({
                        content: p.content[e]
        ...
        _setZoomContent: function (i, a) {
            var r, n, o, s, l, d, c, u, p, f, m, g, h = this,
                v = i.attr("id"),
                w = h._getZoom(v),
                b = h.$modal,
        ...
        _uploadSingle: function (i, a, r, n) {
            var o, s, l, d, c, u, p, f, m, g, h, v, w, b = this,
                _ = b.fileManager,
                C = _.count(),
                x = new FormData,
                y = b._getThumbId(a),
        ...
        _initPreviewActions: function () {
            ...
            i._initZoomButton(), a.find(n).each(function () {
                ...
                if (!t.isEmpty(p) && void 0 !== f) {
                    ...
                    var g, h, v, w, b, _ = u.closest(t.FRAMES),
        ...
        _generatePreviewTemplate: function (i, a, r, n, o, s, l, d, c, u, p, f, m, g) {
            ...
            }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(E ? "other" : i, a, !0, "kv-zoom-thumb", g)), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), h = w(S ? "other" : i, a, !1, "kv-preview-thumb", g), h.setTokens({
                zoomCache: C
            })
        },
        ...
        _getResizedImage: function (i, a, r, n) {
            var o, s, l, d, c, u, p, f, m, g, h = this,
                v = e(a.img)[0],
                w = v.naturalWidth,
                b = v.naturalHeight,
                _ = 1,
