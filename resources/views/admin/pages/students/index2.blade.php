    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col-md-12">
                        <div class="items-push float-sm-left py-2">
                            <a href="{{ route('admin.student.all.addnewstudent') }}"
                                class="btn btn-sm btn-neo btn-block pull-right">Tambah Daftar Siswa</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            <select id='status' class="form-control">
                                ...
                                <option value="100">Sudah Bayar</option>
                                <option value="0">Belum Bayar</option>
                                <option value="-100">Blacklist</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12 col-md-2">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.student.all.all') }}",
                    data: function(d) {
                        d.status = $('#status').val(),
                            d.branch = $('#branch').val(),
