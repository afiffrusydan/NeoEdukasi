                ...
                <div class="block">
                    <div class="block-content block-content-full">
                        <div class="row items-push float-sm-left ">
                            <button type="button" class="btn btn-sm btn-alt-secondary ml-1" 
                                title="Add New Student">
                                <a href="{{ route('admin.student.all.addnewstudent') }}" class="btn btn-sm btn-neo pull-right">Tambah Daftar Siswa</a>
                            </button>
                        </div>
                                            ...
                                            <td class="d-sm-table-cell text-center">
                                                <div class="btn-group center">
                                                    <button type="button" class="btn btn-sm btn-alt-secondary"
                                                        ...
                                                        <a href="{{ route('admin.student.all.view', ['id'=>$student->id]) }}" class="btn btn-sm btn-neo pull-right">Detail</a>
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
