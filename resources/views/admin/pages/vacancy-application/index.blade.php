...
@section('content')
    ...
    <div class="content">
        ...
        <a class=" " href="{{ route('admin.vacancy.vacancy-application.show', ['id'=>$vacancy->id])}}">
                ...
                <div class="block-content block-content-full">
                    <div class="row">
                        <div class="col-xl-9 order-xl-0">
                            ...
                            <div>
                                <a href="{{ route('admin.vacancy.vacancy-application.show', ['id'=>$vacancy->id]) }}">Show Applicant</a>
                            </div>
                        </div>
