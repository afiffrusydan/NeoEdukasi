                            ...
                            <tbody>
                                @foreach ($datas as $studentProgress)
                                    ...
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            <a
                                                href="{{ route('admin.student-report.student-progress.view',['id'=>$studentProgress->id]) }}">{{ $studentProgress->stdFirstName . ' ' . $studentProgress->stdLastName.' '.$studentProgress->month }}</a>
                                        </td>
                                        <td class="fs-sm">
