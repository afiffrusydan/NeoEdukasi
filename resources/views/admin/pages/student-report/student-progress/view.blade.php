        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    Tentored Student Progress <small
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="{{ route('admin.submission.student-progress.index') }}">Tentored Student List</a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="block">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full no-footer dtr-inline collapsed">
                            ...
                            <tbody>
                                @foreach ($data as $studentProgress)

                                    <tr>
                                        <td class="d-none d-md-table-cell fs-sm text-center">{{ $loop->iteration }}</td>
                                        <td class="fs-sm">
                                            <a
                                                href="{{ route('admin.student-report.student-progress.detail',['id'=>$studentProgress->id]) }}">{{ $studentProgress->stdFirstName . ' ' . $studentProgress->stdLastName.' '}}</a>
                                        </td>
                                        <td class="fs-sm">
                                            <a
                                                href="{{ route('admin.student-report.student-progress.detail',['id'=>$studentProgress->id]) }}">{{ $studentProgress->tntrFirstName . ' ' . $studentProgress->tntrLastName.' '}}</a>
                                        </td>
                                        <td class="fs-sm">
                                        ...
                                        <td class="d-none d-sm-table-cell fs-sm text-center">
                                                    ...
                                                    <a href="{{ route('admin.student-report.student-progress.detail',['id'=>$studentProgress->id]) }}"
