...
@section('content')
    ...
    <div class="content">
        ...
        <a class=" " href="{{ route('admin.vacancy.vacancy-application.selected.show', ['id'=>$vacancy->id])}}">
            ...
            background-image:url({{ asset('images/Asset/header-tentors-detail-big-2.png') }});">
                    <div class="row">
                        <div class="col-xl-9 order-xl-0">
                            ...
                            <div>
                                <a class="h6 neo" href="{{ route('admin.vacancy.vacancy-application.selected.show', ['id'=>$vacancy->id]) }}">Tampilkan Pelamar</a>
                            </div>
                        </div>

                        <div class="col-xl-3  text-center">
                            <div style="font-size: 70px">
                                {{ \App\Http\Controllers\Admin\Admin_VacancyController::getSelectedApplicant($vacancy->id) }}
                            </div>
                            Pelamar Terpilih
                        </div>
                    </div>
