                                ...
                                <div id="step-2" class="tab-pane step-content" role="tabpanel" aria-labelledby="step-2">
                                    ...
                                    <div class="row g-3 col-12">
                                        ...
                                        <div id="ktp-declinereason-div" class="form-group col-md-12">
                                            ...
                                            <textarea class="form-control" name="ktp_declinereason" id="ktp-declinereason"
                                ...
                                <div id="step-3" class="tab-pane step-content" role="tabpanel" aria-labelledby="step-3">
                                    ...
                                    <div class="row g-3 col-12">
                                        ...
                                        <div id="ijazah-declinereason-div" class="form-group col-md-12" disabled>
                                            <label class="tittle-neo">Reason</label>
                                            <textarea class="form-control" name="ijazah_declinereason"
                                                id="ijazah-declinereason" rows="2"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div id="step-4" class="tab-pane step-content" role="tabpanel" aria-labelledby="step-4">
                                    ...
                                    <div class="row g-3 col-12">
                                        ...
                                        <div id="transkip-declinereason-div" class="form-group col-md-12" disabled>
                                            <label class="tittle-neo">Reason</label>
                                            <textarea class="form-control" name="transkip_declinereason"
                                                id="transkip-declinereason" rows="2"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div id="step-5" class="tab-pane step-content" role="tabpanel" aria-labelledby="step-5">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group col-md-12">
                                            ...
                                            <div id="ktp-review-div" class="form-group col-md-12" style="display: none;">
                                                <textarea class="form-control" name="ktp-review" id="ktp-review" rows="3"
                                            ...
                                            <div id="ijazah-review-div" class="form-group col-md-12"
                                                style="display: none;">
                                                <textarea class="form-control" name="ijazah-review" id="ijazah-review"
                                            ...
                                            <div id="transkip-review-div" class="form-group col-md-12"
                                                style="display: none;">
                                                <textarea class="form-control" name="transkip-review"
                                                    id="transkip-review" rows="3" readonly="readonly"></textarea>
                                            </div>
