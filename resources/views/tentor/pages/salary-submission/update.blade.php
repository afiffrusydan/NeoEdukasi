            ...
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill h3 my-2">
                        Form Update Pengajuan Gaji<small
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a class="link-fx" href="">Update Pengajuan Gaji</a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-0">
                ...
                <div class="block">
                    ...
                    @endif
                    <form method="POST" action="{{ route('tentor.salary-submission.post-update') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="block-content block-content-full">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality is initialized in js/pages/tables_datatables.js -->
                            <div class="row g-3 col-12-line1">
                                <label class="form-label tittle">Form Update Pengajuan Gaji</label>
                            </div>
