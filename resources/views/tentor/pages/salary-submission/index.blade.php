                        ...
                        <div class="row items-push float-end ">
                            <div class="col-12 col-md-3 py-2">
                                <a href="{{ route('tentor.salary-submission.addnew') }}"
                                    class="btn btn-sm btn-neo btn-block pull-right {{  $errors->has('errors') ? "Disabled" : "" }}" >Add New Submission</a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($stdProgress as $studentProgress)
                                            <tr>
                                                ...
                                                <td class="fs-sm">
                                                    <a
                                                        href="{{ route('tentor.salary-submission.detail',['id'=>$studentProgress->id]) }}">{{ $studentProgress->stdFirstName . ' ' . $studentProgress->stdLastName }}</a>
                                                </td>
                                                <td class="fs-sm">
